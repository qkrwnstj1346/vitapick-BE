...
public class OrdController {
    ...
    // 회원 주문 목록 조회
    @GetMapping
    public ResponseEntity<?> findByUserNum(
    ...
    // 주문서 배송지 목록 조회
    @GetMapping("/address")
    public ResponseEntity<?> findOrderAddress(
            @AuthenticationPrincipal Long userNum) {
        try {
    ...
    // 주문번호 조회
    @GetMapping("/{ordNo}")
    public ResponseEntity<?> findByOrdNo(
    ...
    public ResponseEntity<?> findOrdItByOrdId(
    ...
    public ResponseEntity<?> findByPrdId(
    ...
    public ResponseEntity<?> findPayByOrdId(
            @PathVariable("ordId") Long ordId) {
        try {
    ...
    public ResponseEntity<?> findByPayNo(
